...
// HASH FUNCTION 2 ==>
// A = 8 * (FLOOR(h / 23) + 5)
// KEY = (A * ITEM)  % H [MULIPLICATIVE CONGRUENTIAL METHOD]
...
int main()
{
    ...
    double time_taken_total = (((double)(end_1 - start_1)) / CLOCKS_PER_SEC) + (((double)(end_2 - start_2)) / CLOCKS_PER_SEC); // in seconds
    ...
    printf("CPU Time for insertion = %f\n", time_taken_1);
    printf("CPU Time for search = %f\n", time_taken_2);
    printf("\n");
